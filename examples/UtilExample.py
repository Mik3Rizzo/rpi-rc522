...
while True:
    ...
    if not error:
        ...
        if not error:
            ...
            util.set_auth(rdr.auth_b, [0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF])
            ...
            util.set_auth(rdr.auth_a, [0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF])
            ...
            util.auth(util.get_block_address(2, 1))
            ...
            util.write_block(9, [None, None, 0xAB, 0xCD, 0xEF])
